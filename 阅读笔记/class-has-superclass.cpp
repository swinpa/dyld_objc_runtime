...
static __NSConstantStringImpl __NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_0 __attribute__ ((section ("__DATA, __cfstring"))) = {__CFConstantStringClassReference,0x000007c8,"xiao ming",9};
static __NSConstantStringImpl __NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_1 __attribute__ ((section ("__DATA, __cfstring"))) = {__CFConstantStringClassReference,0x000007c8,"2020/10/10",10};
static __NSConstantStringImpl __NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_2 __attribute__ ((section ("__DATA, __cfstring"))) = {__CFConstantStringClassReference,0x000007c8,"xiao fei",8};
static __NSConstantStringImpl __NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_3 __attribute__ ((section ("__DATA, __cfstring"))) = {__CFConstantStringClassReference,0x000007c8,"2018/1/1",8};
static __NSConstantStringImpl __NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_4 __attribute__ ((section ("__DATA, __cfstring"))) = {__CFConstantStringClassReference,0x000007c8,"man- name",9};
static __NSConstantStringImpl __NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_5 __attribute__ ((section ("__DATA, __cfstring"))) = {__CFConstantStringClassReference,0x000007c8,"135",3};
...
static NSString * _I_Person_pName(Person * self, SEL _cmd) { return (*(NSString **)((char *)self + OBJC_IVAR_$_Person$_pName)); }
extern "C" __declspec(dllimport) void objc_setProperty (id, SEL, long, id, bool, bool);

static void _I_Person_setPName_(Person * self, SEL _cmd, NSString *pName) { objc_setProperty (self, _cmd, __OFFSETOFIVAR__(struct Person, _pName), (id)pName, 0, 1); }
...
extern "C" unsigned long OBJC_IVAR_$_Man$_pPhone;
extern "C" unsigned long OBJC_IVAR_$_Man$_exGirlName;
struct Man_IMPL {
    //这里包含了父类的成员变量的结构体
	struct Person_IMPL Person_IVARS;
	int varGirls;
	NSString *_pPhone;
	NSString *_exGirlName;
};
...
// @property (nonatomic, copy) NSString *exGirlName;
...
int main(int argc, char * argv[]) {
    ...
    ((void (*)(id, SEL, NSString *))(void *)objc_msgSend)((id)p1, sel_registerName("setPName:"), (NSString *)&__NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_0);
    ((void (*)(id, SEL, NSInteger))(void *)objc_msgSend)((id)p1, sel_registerName("setPAge:"), (NSInteger)18);
    ((void (*)(id, SEL, NSString *))(void *)objc_msgSend)((id)p1, sel_registerName("setExBirthday:"), (NSString *)&__NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_1);
    //根据对象地址以及成员变量相对于对象地址的偏移量可以计算得到存放成员变量的内存地址
    ...
    ((void (*)(id, SEL, NSString *))(void *)objc_msgSend)((id)p2, sel_registerName("setPName:"), (NSString *)&__NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_2);
    ((void (*)(id, SEL, NSInteger))(void *)objc_msgSend)((id)p2, sel_registerName("setPAge:"), (NSInteger)20);
    ((void (*)(id, SEL, NSString *))(void *)objc_msgSend)((id)p2, sel_registerName("setExBirthday:"), (NSString *)&__NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_3);
    (*(int *)((char *)p2 + OBJC_IVAR_$_Person$varHeight)) = 165;
    (*(int *)((char *)p2 + OBJC_IVAR_$_Person$varWeight)) = 48;

    NSString *p1n = ((NSString *(*)(id, SEL))(void *)objc_msgSend)((id)p1, sel_registerName("pName"));

    Man *m = ((Man *(*)(id, SEL))(void *)objc_msgSend)((id)((Man *(*)(id, SEL))(void *)objc_msgSend)((id)objc_getClass("Man"), sel_registerName("alloc")), sel_registerName("init"));
    ((void (*)(id, SEL, NSString *))(void *)objc_msgSend)((id)m, sel_registerName("setPName:"), (NSString *)&__NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_4);
    ((void (*)(id, SEL, NSString *))(void *)objc_msgSend)((id)m, sel_registerName("setPPhone:"), (NSString *)&__NSConstantStringImpl__var_folders_f3_6cl3xw6j4nl8414jl94d5yzm0000gn_T_clangMain_0d5899_mi_5);
...
static struct _class_ro_t _OBJC_CLASS_RO_$_Person __attribute__ ((used, section ("__DATA,__objc_const"))) = {
	0, __OFFSETOFIVAR__(struct Person, varWeight), sizeof(struct Person_IMPL), 
	0, 
	"Person",
...
extern "C" unsigned long int OBJC_IVAR_$_Man$varGirls __attribute__ ((used, section ("__DATA,__objc_ivar"))) = __OFFSETOFIVAR__(struct Man, varGirls);
extern "C" unsigned long int OBJC_IVAR_$_Man$_pPhone __attribute__ ((used, section ("__DATA,__objc_ivar"))) = __OFFSETOFIVAR__(struct Man, _pPhone);
extern "C" unsigned long int OBJC_IVAR_$_Man$_exGirlName __attribute__ ((used, section ("__DATA,__objc_ivar"))) = __OFFSETOFIVAR__(struct Man, _exGirlName);
...
static struct /*_ivar_list_t*/ {
	...
	sizeof(_ivar_t),
	3,
	{{(unsigned long int *)&OBJC_IVAR_$_Man$varGirls, "varGirls", "i", 2, 4},
	 {(unsigned long int *)&OBJC_IVAR_$_Man$_pPhone, "_pPhone", "@\"NSString\"", 3, 8},
	 {(unsigned long int *)&OBJC_IVAR_$_Man$_exGirlName, "_exGirlName", "@\"NSString\"", 3, 8}}
};
...
static struct /*_method_list_t*/ {
	...
	8,
	{
        {(struct objc_selector *)"pPhone", "@16@0:8", (void *)_I_Man_pPhone},
	
        {(struct objc_selector *)"setPPhone:", "v24@0:8@16", (void *)_I_Man_setPPhone_},
	
        {(struct objc_selector *)"exGirlName", "@16@0:8", (void *)_I_Man_exGirlName},
	
        {(struct objc_selector *)"setExGirlName:", "v24@0:8@16", (void *)_I_Man_setExGirlName_},
...
static struct /*_prop_list_t*/ {
	...
	sizeof(_prop_t),
	1,
	{{"pPhone","T@\"NSString\",C,N,V_pPhone"}}
};
...
static struct _class_ro_t _OBJC_CLASS_RO_$_Man __attribute__ ((used, section ("__DATA,__objc_const"))) = {
	0, __OFFSETOFIVAR__(struct Man, varGirls), sizeof(struct Man_IMPL), 
	0, 
	"Man",
